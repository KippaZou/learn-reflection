...
var fileDescriptor_c161fcfdc0c3ff1e = []byte{
	...
	0x8c, 0x1a, 0x3c, 0x50, 0x71, 0x73, 0x27, 0xa1, 0x13, 0x8f, 0xe4, 0x18, 0x2f, 0x3c, 0x92, 0x63,
	0x7c, 0xf0, 0x48, 0x8e, 0x31, 0x8a, 0x05, 0xe4, 0x89, 0x24, 0x36, 0xb0, 0x87, 0x8c, 0x01, 0x01,
	0x00, 0x00, 0xff, 0xff, 0x53, 0x79, 0x6d, 0x40, 0xe5, 0x00, 0x00, 0x00,
}
...
func (m *Demo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Field7) > 0 {
		...
		i = encodeVarintTest(dAtA, i, uint64(len(m.Field7)))
		i--
		dAtA[i] = 0x3a
	}
	if len(m.Field6) > 0 {
		...
		i = encodeVarintTest(dAtA, i, uint64(len(m.Field6)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.Field5) > 0 {
		...
		i = encodeVarintTest(dAtA, i, uint64(len(m.Field5)))
		i--
		dAtA[i] = 0x2a
	}
	if m.Field4 != 0 {
		i = encodeVarintTest(dAtA, i, uint64(m.Field4))
		i--
		dAtA[i] = 0x20
	}
	if len(m.Field3) > 0 {
		for iNdEx := len(m.Field3) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.Field3[iNdEx])
			copy(dAtA[i:], m.Field3[iNdEx])
			i = encodeVarintTest(dAtA, i, uint64(len(m.Field3[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
